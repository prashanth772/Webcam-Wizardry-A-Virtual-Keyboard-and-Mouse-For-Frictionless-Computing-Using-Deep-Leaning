...
train = pd.read_csv("D:\\MiniProject\\DataSet from Eminist\\emnist-byclass-train.csv", delimiter=',')
test = pd.read_csv("D:\\MiniProject\\DataSet from Eminist\\emnist-byclass-test.csv", delimiter=',')
...
# Train: (697931, 785), Test: (116322, 785), Map: (61, 2)
# (697931, 784) (697931,) (116322, 784) (116322,)
# train_x: (697931, 28, 28)
# test_x: (116322, 28, 28)
# Validation Accuracy: 0.31901251549213033
# Test Accuracy: 0.3222864118567425
# Confusion Matrix:
# [[5253   65   75 ...    0    0    0]
#  [   1 6184    3 ...    0    0    0]
#  [ 339  441 3665 ...    0    0    0]
